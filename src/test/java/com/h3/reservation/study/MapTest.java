...
public class MapTest {
    ...
    void groupby() {
        ...
        reservations.add(Reservation.of(MeetingRoom.ROOM3, "희봉", "프로젝트", "2019-12-10", "10:30", "12:00"));
        reservations.add(Reservation.of(MeetingRoom.ROOM1, "코니", "회고", "2019-12-10", "13:00", "15:30"));
        reservations.add(Reservation.of(MeetingRoom.ROOM2, "도넛", "굴러간다", "2019-12-10", "13:00", "14:00"));
        reservations.add(Reservation.of(MeetingRoom.ROOM3, "버디", "회의", "2019-12-10", "13:00", "14:00"));
